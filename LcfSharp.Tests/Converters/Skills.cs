...
namespace LcfSharp.Tests.Converters
{
    ...
    public class Skills
    {
        ...
        byte[] data = new byte[]
        {
            
        };
        ...
        Skill instance = new Skill
        {
            ...
            AbsorbDamage = false,
            IgnoreDefense = false,
            StateEffects = new List<bool> { false, false, false, false, false, false, false, true },
            AttributeEffects = [],
